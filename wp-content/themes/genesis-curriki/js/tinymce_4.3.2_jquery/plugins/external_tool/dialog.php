...
//    echo '<iframe id="contentframe" height="600" width="100%" frameborder="0" scrolling="auto" src="https://demo.curriki.me/lti-launch?id=45" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
//    echo '<input type="hidden" id="popup" value="Test" />';
//    die();
//    include('upload.php');
} else {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
            <div class="box">
                <form method="POST" action="/curriki-xapi-app/public/admin/activities/save">
                    <input type="hidden" name="lesson_id" value="14"/>
                    <input type="hidden" name="lti_typename" value=""/>
                    <input type="hidden" name="lti_description" value=""/>
                    <input type="hidden" name="lti_icon" value=""/>
                    <input type="hidden" name="lti_secureicon" value=""/>
                    <input type="hidden" name="lti_clientid" value="1570714708" />
                    <input type="hidden" name="lti_ltiversion" value="LTI-1p0" />
                    <input type="hidden" name="lti_publickey" value="" />
                    <input type="hidden" name="lti_initiatelogin" value="" />
                    <input type="hidden" name="lti_redirectionuris" value="" />
                    <input type="hidden" name="lti_customparameters" value="" />
                    <input type="hidden" name="lti_contentitem" value="" />
                    <input type="hidden" name="submit_lti_tool" value="Add" />
                    <input type="hidden" name="thumb" value="lesson_thumbnails/3ZaqGnFDlNfqzmhFyzNU69n1ErevDP5IIXbJ3rjj.png" />
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="lti_toolurl">Tool URL</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="lti_toolurl" id="lti_toolurl" aria-describedby="lti_toolurl" placeholder="Tool URL" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="lti_resourcekey">Consumer Key</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="lti_resourcekey" id="lti_resourcekey" aria-describedby="lti_resourcekey" placeholder="Consumer Key" value="<?php echo md5(uniqid(rand(), true)); ?>" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="lti_password">Consumer Secret</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="lti_password" id="lti_password" aria-describedby="lti_password" placeholder="Consumer Secret" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
