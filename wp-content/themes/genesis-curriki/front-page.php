...
function my_custom_js() {
    echo '<!-- Start of HubSpot Embed Code --><script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/7874555.js"></script><!-- End of HubSpot Embed Code -->';
}
...
function curriki_home_body_blocks() {
	...
	echo '<div class="home-row home-hero">';
		echo '<div class="wrap container_12 row">';
			echo '<div class="col-md-5">';
				echo '<div class="home-hero-text">';
					echo '<h1>Powering the creation of <br>the world’s most<br> immersive learning<br> experiences.</h1>';
					echo '<div class="home-hero-inner">';
						echo '<p>Introducing the world’s first end to end, OPEN learning content authoring suite, <span class="text-black">CurrikiStudio.</span></p>';
						echo '<p><a class="btn btn-hero" href="https://www.curriki.org/currikistudio-overview/">LEARN MORE <i class="fa fa-long-arrow-right"></i></a></p>';
						echo '<p><a class="btn btn-hero" href="https://www.curriki.org/early-access/">Request Early Access <i class="fa fa-long-arrow-right"></i></a></p>';
					echo '</div>';
				echo '</div>';
			echo '</div>';
			echo '<div class="col-md-7">';
				echo '<div class="hero-image-wrap">';
					echo '<img src="https://www.curriki.org/wp-content/uploads/2020/05/img-header-home-1.png" width="1600" height="1161" alt="Powering the creation of the world&apos;s most immersive learning experiences.">';
				echo '</div>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
