<?php
    wp_enqueue_style('oer-custom-style', get_stylesheet_directory_uri() . '/groups/styles/invite-anyone.css');
?>
...
<?php
    ...
    {
?>        
        <?php require_once 'manage-invites.php'; ?>
        ...
        if ( function_exists( 'bp_post_get_permalink' ) ) { // ugly ugly ugly hack to check for pre-1.2 versions of BP
                                        ...
                                        <div class="left-menu">
                                                ...
                                                <ul class="first acfb-holder">
                                                        <li>
                                                                ...
                                                                <p class="small-label"><i>Please enter minimum 3 characters</i></p>
                                                        </li>
                                                </ul>
                ...
                <?php if ( invite_anyone_access_test() && !bp_is_group_create() ) : ?>
                    <p>
                        ...
                        {
                        ?>                
                            <a href="<?php echo bp_loggedin_user_domain() . BP_INVITE_ANYONE_SLUG . '/sent-invites/?manage=1' ?>"> <strong><?php _e( 'Manage invitations by email.', 'invite-anyone' ) ?></strong> </a> | <a href="<?php echo site_url() ?>/groups/<?php echo bp_get_group_slug() ?>/admin">Back to '<strong>Manage Group</strong>'</a>
                        <?php
                        }else{
                        ?>
                            <?php _e( 'Want to invite someone to the group who is not yet a member of the site?', 'invite-anyone' ) ?> <a href="<?php echo bp_loggedin_user_domain() . BP_INVITE_ANYONE_SLUG . '/invite-new-members/group-invites/' . bp_get_group_id() ?>"> <strong><?php _e( 'Send invitations by email.', 'invite-anyone' ) ?></strong> </a>
                            <!--<a class="follow green-button sent-invite-back-btn" href="<?php //echo site_url(); ?>/groups/<?php //echo bp_get_current_group_slug(); ?>">Back</a>-->
                            <?php
                        }
                        ?>
                   </p>
                ...
                <div class="left-menu">
                    ...
                    <?php if( bp_get_new_group_id() > 0 ) { ?>
                        <!-- <p><?php _e( 'Want to invite someone to the group who is not yet a member of the site?', 'invite-anyone' ) ?></p>
                        <p>
                            <a href="<?php //echo bp_loggedin_user_domain() . BP_INVITE_ANYONE_SLUG . '/invite-new-members/group-invites/' . bp_get_new_group_id() ?>"> <strong><?php //_e( 'Send invitations by email.', 'invite-anyone' ) ?></strong> </a>
                        </p>-->
                    <?php } ?>
