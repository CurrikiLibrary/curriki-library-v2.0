...
if( isset($_GET["iaaction"]) && $_GET["iaaction"] === "accept-invitation" )
{
    require_once 'register-accept-invite.php';
}else{ ?>
    <!-- ========================================================================================================== -->
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'registration-disabled' == bp_get_current_signup_step() ) : ?>
			<?php do_action( 'template_notices' ); do_action( 'bp_before_registration_disabled' ); ?>
		...
		<?php elseif ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<?php do_action( 'template_notices' ); do_action( 'bp_before_registration_confirmed' ); ?>
