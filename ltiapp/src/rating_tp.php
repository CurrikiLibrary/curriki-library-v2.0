 ...
 */
  ...
  class RatingToolProvider extends ToolProvider\ToolProvider {
    ...
    function __construct($data_connector) {
      ...
      $requiredMessages = array(new Profile\Message('basic-lti-launch-request', 'curriki-resources.php', array('User.id', 'Membership.role')));
      $optionalMessages = array(new Profile\Message('ContentItemSelectionRequest', 'curriki-resources.php', array('User.id', 'Membership.role')),
    ...
    function onLaunch() {
        ...
        */       
        ...
        $this->redirectUrl = getAppUrl()."index.php?tmr=". time();               
    }
