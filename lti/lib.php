...
//  error_reporting(E_ALL);
  ...
  require_once('db.php');
  require_once('dbsession/LTISessionHandler.php');
...
// Set session cookie path
    ...
    //session_set_cookie_params(0,  getAppPath());
    
    $settings_obj = new stdClass();    
    $settings_obj->pdo_data_source_name = DB_NAME;
    $settings_obj->pdo_username = DB_USERNAME;
    $settings_obj->pdo_password = DB_PASSWORD;
    //$settings_obj->session_db_table = DB_TABLENAME;
    //$settings_obj->session_name = "CURSESSION";    
    
    $session_handler = new LTISessionHandler($settings_obj);
