 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
require_once app_path('Curriki/curriki-lti/lti/classes/local/ltiservice/service_base.php');
require_once app_path('Curriki/curriki-lti/lti/service/basicoutcomes/classes/local/resources/basicoutcomes.php');
...
class basicoutcomes extends service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new basicoutcomes_rs($this);
        }
