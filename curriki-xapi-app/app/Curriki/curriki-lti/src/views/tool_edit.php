...
<h1>LTI Tool Setings</h1>

<form action="<?php echo admin_url('admin.php?page=curriki-wp-lti&controller=toolsettings&action=tool_edit&id='.$_GET['id']); ?>" method="post">
<input type="hidden" name="tool_id" id="tool_id" value="<?php echo $_GET['id']; ?>" />
<div class="fcontainer clearfix" id="yui_3_17_2_1_1564474566068_220">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Tool name" aria-label="Help with Tool name"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text" id="yui_3_17_2_1_1564474566068_259">
        <input type="text" class="form-control " name="lti_typename" id="id_lti_typename" value="<?php echo $config->lti_typename; ?>" size="">
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text">
        <input type="text" class="form-control " name="lti_toolurl" id="id_lti_toolurl" value="<?php echo $config->lti_toolurl; ?>" size="64">
...
<p>This should describe what the tool is for and what it does and any additional information the teacher may need to know.</p>
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Tool description" aria-label="Help with Tool description"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="textarea">
        <textarea name="lti_description" id="id_lti_description" class="form-control " rows="4" cols="60"><?php echo $config->lti_description; ?></textarea>
...
<div id="fitem_id_lti_ltiversion" class="form-group row fitem">
    <div class="col-md-9 form-inline felement" data-fieldtype="select">
        ...
        <strong><?php echo $config->lti_ltiversion; ?></strong>
        <!-- <input type="hidden" name="lti_ltiversion" id="id_lti_ltiversion" value="<?php //echo $config->lti_ltiversion; ?>" /> -->
    </div>
</div>

<?php if($config->lti_ltiversion === 'LTI-1p0'){ ?>
<div id="fitem_id_lti_resourcekey" class="form-group row  fitem">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Consumer key" aria-label="Help with Consumer key"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text" id="yui_3_17_2_1_1564474566068_204">
        <!-- <input type="text" class="form-control " name="lti_resourcekey" id="id_lti_resourcekey" value="" size=""> -->
        <strong><?php echo $config->lti_resourcekey; ?></strong>
        <div class="form-control-feedback invalid-feedback" id="id_error_lti_resourcekey">
            
        </div>
    </div>
</div><div id="fitem_id_lti_password" class="form-group row fitem">
    <div class="col-md-3">
        <span class="float-sm-right text-nowrap">
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="passwordunmask" id="yui_3_17_2_1_1564474566068_207">
        <span data-passwordunmask="wrapper" data-passwordunmaskid="id_lti_password" id="yui_3_17_2_1_1564474566068_206">
            <span data-passwordunmask="editor" id="yui_3_17_2_1_1564474566068_205">
                <!-- <input type="hidden" name="lti_password" id="id_lti_password" value="" class="form-control d-inline-block" data-size="" disabled="disabled"> -->
                <strong><?php echo $config->lti_password; ?></strong>
            </span>                       
        </span>
...
<?php
if(!is_null($config->lti_clientid) && strlen($config->lti_clientid) > 0 && $config->lti_ltiversion === '1.3.0'){ ?>
<div id="fitem_id_lti_clientid_disabled" class="form-group row  fitem   ">
...
be part of the details passed to the provider of the tool so that they can configure the connection at their end.</p>
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Client ID" aria-label="Help with Client ID" id="yui_3_17_2_1_1564474566068_247"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text" id="yui_3_17_2_1_1564474566068_201">
        <input type="text" class="form-control " name="lti_clientid_disabled" id="id_lti_clientid_disabled" value="<?php echo $config->lti_clientid?>" size="" disabled="disabled">
...
<div id="fitem_id_lti_publickey" class="form-group row  fitem   ">
<?php if(property_exists($config,'lti_publickey') && $config->lti_ltiversion === '1.3.0'){ ?>
    <div class="col-md-3">
        <span class="float-sm-right text-nowrap">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Public key" aria-label="Help with Public key"></i>
        ...
        <div class="col-md-9 form-inline felement" data-fieldtype="textarea" id="yui_3_17_2_1_1564474566068_253">
            <textarea name="lti_publickey" id="id_lti_publickey" class="form-control " rows="8" cols="60"><?php echo $config->lti_publickey?></textarea>
...
</div><div id="fitem_id_lti_initiatelogin" class="form-group row  fitem   ">
    <div class="col-md-3">
    <?php if(property_exists($config,'lti_initiatelogin') && $config->lti_ltiversion === '1.3.0'){ ?>
        <span class="float-sm-right text-nowrap">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Initiate login URL" aria-label="Help with Initiate login URL"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text">
        <input type="text" class="form-control " name="lti_initiatelogin" id="id_lti_initiatelogin" value="<?php echo $config->lti_initiatelogin?>" size="64">
...
<?php if(property_exists($config,'lti_redirectionuris') && $config->lti_ltiversion === '1.3.0'){ ?>
<div id="fitem_id_lti_redirectionuris" class="form-group row  fitem   ">
    <div class="col-md-3">
        <span class="float-sm-right text-nowrap">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Redirection URI(s)" aria-label="Help with Redirection URI(s)"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="textarea">
        <textarea name="lti_redirectionuris" id="id_lti_redirectionuris" class="form-control " rows="3" cols="60"><?php echo $config->lti_redirectionuris?></textarea>
...
<p>It is safe to leave this field unchanged unless directed by the tool provider.</p>
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Custom parameters" aria-label="Help with Custom parameters"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="textarea">
        <textarea name="lti_customparameters" id="id_lti_customparameters" class="form-control " rows="4" cols="60"><?php echo $config->lti_customparameters?></textarea>
...
<div class="form-group row fitem advanced show">
    ...
    <div class="col-md-9 checkbox">
        <div class="form-check">
            <label>                    
                    <input type="checkbox" name="lti_contentitem" class="form-check-input " value="1" id="id_lti_contentitem" <?php echo $config->lti_contentitem == 1 ? 'checked=checked':'' ?>>
...
LTI icon, an icon which conveys the type of activity may be specified.</p>
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Icon URL" aria-label="Help with Icon URL"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text">
        <input type="text" class="form-control " name="lti_icon" id="id_lti_icon" value="<?php echo $config->lti_icon?>" size="64">
  ...
  <i class="icon fa fa-question-circle text-info fa-fw " title="Help with Secure icon URL" aria-label="Help with Secure icon URL"></i>
    ...
    <div class="col-md-9 form-inline felement" data-fieldtype="text">
        <input type="text" class="form-control " name="lti_secureicon" id="id_lti_secureicon" value="<?php echo $config->lti_secureicon?>" size="64">
        <div class="form-control-feedback invalid-feedback" id="id_error_lti_secureicon">
            
        </div>
    </div>
</div>
    <input type="submit" name="submit_lti_tool" value="Update" />
    |
