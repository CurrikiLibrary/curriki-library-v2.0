			...
			<div class="data-box">
				...
				<div class="data-body" style="height:50em;">
					<div class="text-center">
						<embed src="{{ asset('assets/electronic-control-systems-2.pdf') }}" width="100%" style="height:40em;"type="application/pdf">
					</div>	
				</div>
			</div>
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/4/activity/1')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/4/activity/3')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
