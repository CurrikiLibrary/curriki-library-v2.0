...
@section('content')
	<div class="jumbotron px-0">
		<div class="container">
							...
							<div class="row d-md-flex align-items-center">
								<div class="col-md-6">
									<div class="bg-gray rounded p-5 font-size-md-30 text-center mb-3">
										According to the Electronic Control Systems, these kinds of rights can never be taken away...
									</div>
								</div>
								<div class="col-md-6 ">
									<div class="px-md-4">
			...
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/4/activity/10')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/4/activity/12')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
