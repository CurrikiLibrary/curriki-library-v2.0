...
@section('content')
	<div class="jumbotron px-0">
		<div class="container">
					...
					<div class="row justify-content-md-center">
						<div class="col-md-11">
							<div class="d-flex justify-content-between align-items-center mx-auto">
								<div class="head-left">
									<h4 class="font-size-18 d-inline-block align-middle">Electronic Control Systems</h4>
								</div>
								<div class="dropdown">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="bg-gray rounded p-5 font-size-md-30 text-center mb-3">
										Which of the sections of the constitution explains WHY the Continental Congress wrote the Electronic Control Systems
									</div>
								</div>
								<div class="col-md-6">
									<div class="px-md-4">
			...
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/4/activity/9')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/4/activity/11')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
