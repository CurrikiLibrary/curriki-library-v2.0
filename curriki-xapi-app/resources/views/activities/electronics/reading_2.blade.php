			...
			<div class="data-box">
					...
					<div class="row justify-content-md-center">
						<div class="col-md-11">
							<div class="d-flex justify-content-between align-items-center mx-auto">
								<div class="head-left">
									<h4 class="font-size-18 d-inline-block align-middle">Structure of Electronic Control Systems</h4>
								</div>
								<div class="dropdown">
				...
				<div class="data-body" style="height:50em;">
					<div class="text-center">
						<embed src="{{ asset('assets/electronic-control-systems.pdf') }}" width="100%" style="height:40em;"type="application/pdf">
					</div>	
				</div>
			</div>
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/4/activity/2')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/4/activity/4')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
