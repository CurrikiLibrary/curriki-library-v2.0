...
@section('content')
	<div class="jumbotron px-0">
		<div class="container">
						    ...
						    <div class="quickFlip">
						        ...
						        <div>
									<div class="bg-gray rounded p-5 font-size-md-30 text-center mb-3">
										Right Angle
										<br>
										<img class="img-fluid" src="{{asset('images/activities/flipcard_2.png')}}">
										<br>
										<a class="btn btn-lg rounded-circle text-gray-o quickFlipCta"><i class="fa fa-refresh"></i></a>
									</div>
						        </div>
			...
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/2/activity/4')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/2/activity/6')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
