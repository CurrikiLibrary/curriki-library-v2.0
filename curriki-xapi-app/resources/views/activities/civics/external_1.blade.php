	...
	<div class="jumbotron px-0">
		<div class="container">
			<div class="data-box">
				...
				<div class="data-body">
					<iframe src="https://www.curriculumpathways.com/portal/Launch?id=C4190"></iframe>
				</div>
			</div>
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/3/activity/3')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/3/activity/5')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
