...
@section('content')
	<div class="jumbotron px-0">
		<div class="container">
						    ...
						    <div class="quickFlip">
						        ...
						        <div>
									<div class="bg-gray rounded p-5 font-size-md-30 text-center mb-3">
										...
										<br>
										<img class="img-fluid" src="{{asset('images/activities/civics_flipcard_3.jpg')}}" >
										<br>
										<a class="btn btn-lg rounded-circle text-gray-o quickFlipCta"><i class="fa fa-refresh"></i></a>
									</div>
						        </div>
			...
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/3/activity/6')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/3/activity/8')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
