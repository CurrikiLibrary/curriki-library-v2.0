...
@section('content')
	<div class="jumbotron px-0">
		<div class="container">
			...
			<div class="row pt-4">
				<div class="col-md-12">
					<a class="btn btn-blue pull-left" href="{{url('/lesson/3/activity/8')}}">Previous activity</a>
					<a class="btn btn-blue pull-right" href="{{url('/lesson/3/activity/10')}}">Next activity</a>
				</div>
			</div>
		</div>
	</div>
