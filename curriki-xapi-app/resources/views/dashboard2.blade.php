				...
				<div class="tab-pane fade show active" id="dashboard-tab" role="tabpanel" aria-labelledby="nav-dashboard-tab">
					<form class="form-dashboard mb-5" method="get" action="#">
						<div class="input-addon">
							...
							<input class="form-control" type="text" placeholder="Reminders: Physics Webinar Test Thu 9:00 AM - Business Ethics Workshop Fri 10:00 AM - Math Test Fri 1:00 PM...">
							<i class="fa fa-angle-down"></i>
						</div>
					</form>
					<div class="ibox mb-4">
						<div class="d-flex justify-content-between align-items-center w-100 font-size-18 pb-4">
							<h3 class="font-size-18 font-weight-semibold text-black">My Career Path</h3>
							...
							<div class="owl-carousel owl-theme">
								<div class="item">
									...
									<div class="caption">
										...
										<h4 class="font-size-14 font-weight-normal"><a href="{{url('/lesson/3')}}">Entrepeneurship</a></h4>
									</div>
								</div>
								<div class="item">
									<div class="thumbnail mb-2">
									...
									<div class="caption">
										...
										<h4 class="font-size-14 font-weight-normal"><a href="{{ url('/lesson/1') }}">Physics Fundamentals</a></h4>
									</div>
								</div>
								<div class="item">
									<div class="thumbnail mb-2">
									...
									<div class="caption">
										...
										<h4 class="font-size-14 font-weight-normal"><a href="{{ url('/lesson/2') }}">Basic Math Topics</a></h4>
									</div>
								</div>
								<div class="item">
									<div class="thumbnail mb-2">
										<a href="#">
											<img class="img-fluid img-radius-all" src="{{asset('images/electronics.png')}}" width="310" height="211" alt="Concepts of music">
										</a>
										<div class="thumbnail-overlay">
											<div class="overlay-icon">
												<a href="#"><i class="fa fa-heart"></i></a>
									...
									<div class="caption">
										...
										<h4 class="font-size-14 font-weight-normal">Intro To Electronics</h4>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ibox mb-4">
						<div class="d-flex justify-content-between align-items-center w-100 font-size-18 pb-4">
							<h3 class="font-size-18 font-weight-semibold text-black">Explore Career Options</h3>
							<a class="underline" href="#">See All</a>
						</div>
						<div class="ibox-body">
							<div class="owl-carousel owl-theme">
								<div class="item">
									<div class="thumbnail">
										<a href="#">
											<img class="img-fluid img-radius-top" src="{{asset('images/science-and-technology.png')}}" width="310" height="185" alt="Atoms">
										</a>
									</div>
									<div class="recent-desc">
										<div class="recent-title"><i class="icon-v2">P</i> Science & Technology</div>
								...
								<div class="item">
									<div class="thumbnail">
										<a href="#">
											<img class="img-fluid img-radius-top" src="{{asset('images/logistics.png')}}" width="310" height="185" alt="Literary analysis">
										</a>
									</div>
									<div class="recent-desc">
										<div class="recent-title"><i class="icon-v2 icon-blue">W</i> Transportation & Logistics</div>
								...
								<div class="item">
									<div class="thumbnail">
										<a href="#">
											<img class="img-fluid img-radius-top" src="{{asset('images/sales-marketing.png')}}" width="310" height="185" alt="Declaration of Independence">
										</a>
									</div>
									<div class="recent-desc">
										<div class="recent-title"><i class="icon-v2">P</i> Marketing & Sales</div>
								...
								<div class="item">
									<div class="thumbnail">
										<a href="#">
											<img class="img-fluid img-radius-top" src="{{asset('images/audio-video.png')}}" width="310" height="185" alt="Analytic Geometry Basic Concepts">
										</a>
									</div>
									<div class="recent-desc">
										<div class="recent-title"><i class="icon-v2">P</i> Audio & Video Technologies</div>
